...
<div className={'markContainer'}>
    <svg role="img" aria-labelledby="successSVG" className="mark" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">
    <title id="successSVG">Success Checkmark</title>
...
<React.Fragment>
<div className={'markContainer'}>
    <svg role="img" aria-labelledby="errorSVG" className="mark" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">
    <title id="errorSVG">Error Crossmark</title>
